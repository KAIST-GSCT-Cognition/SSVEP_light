...
class Logger(SummaryWriter):
    ...
    def log_train_ssl_loss(self, loss, steps):
        self.add_scalar('ssl_loss', loss.item(), steps)
    
    def log_train_essl_loss(self, loss, steps):
        self.add_scalar('essl_loss', loss.item(), steps)

    def log_train_essl_logit(self, essl_logger, steps):
        for name, loss in essl_logger.items():
            self.add_scalar(name, loss.item(), steps)
